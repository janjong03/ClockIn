...
public class MySQLiteHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase database) {
		database.execSQL("CREATE TABLE clockin(clockInID integer primary key autoincrement, clockinTime integer not null, clockoutTime integer);");
		database.execSQL("Create TABLE break(breakID integer primary key autoincrement, breakOutTime integer not null, breakInTime integer, clockinID integer not null, FOREIGN KEY(clockinID) references clockin(clockinID);");
